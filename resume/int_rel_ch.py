...
def resume_max_tracks():
    ...
    if opt.tr_correct:
        resume_str = opt.data_root + '/models_release/gt_int_rel_ch_sum_max.pth.tar'
    else:
        resume_str = opt.data_root + '/models_release/weak_int_rel_ch_sum_max.pth.tar'
